...
async function minimalFill(page) {
  ...
  if (!(await form.count())) console.log('INVALID_FIELDS: [ "NO_FORM" ]');
...
test('Monthly Booking - Normal Journey Test: complete normal booking with early booking campaign', async ({ page }) => {
